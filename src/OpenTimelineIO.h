...
typedef struct{
	int64 integer;/* Describes an integer value. */
	uint8 decimal;/* Describes the number of decimals the value is to be divided by. */
}OTIODecimal;

typedef struct{
	OTIODecimal value; /* Number of frames / samples */
	OTIODecimal rate; /* Rate of number of frames / samples per second */
}OTIOTime;
